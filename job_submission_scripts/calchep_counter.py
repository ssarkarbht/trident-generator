...
#extract event index
data_arr=infile['CH+DF_interactions']['interaction_param']['event_id']

#failsafe for last job segment in case iteration ends before reaching
#total events per job value
data_len=len(data_arr)
print ("Total number of Coherent+Diffractive events in this batch: ", data_len)
...
#    print ('{:05d}'.format(data_arr[evt_index]))
